...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["active"])
    ...
    if (CModule::IncludeModule("socialnetwork")) {
        $res = false;
        $canEdit = ($USER->CanDoOperation('edit_own_profile')
            || $USER->IsAdmin()) ? "Y" : "N";
        $userId = intval($_POST["user_id"]);
        $CurrentUserPerms = CSocNetUserPerms::InitUserPerms($USER->GetID(),
            $userId, CSocNetUser::IsCurrentUserModuleAdmin($_POST["site_id"],
