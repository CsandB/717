            ...
            <td class="bx-im-fullscreen-popup-td bx-im-fullscreen-popup-td1">
                <div class="bx-im-fullscreen-popup-logo">
                    <? if (IsModuleInstalled("bitrix24")): ?>
                        <span><?
                            $clientLogo = COption::GetOptionInt("bitrix24",
                                "client_logo", ""); ?>
                            <? if ($clientLogo): ?>
                                <img src="<? if ($clientLogo) echo CFile::GetPath($clientLogo) ?>"/>
                            <? else: ?>
                                <?= htmlspecialcharsbx(COption::GetOptionString("bitrix24",
                                    "site_title",
                    ...
                    <? else:
                        $logoID = COption::GetOptionString("main",
                            "wizard_site_logo", "", SITE_ID);
                        ?><span>
                        <? if ($logoID):
                ...
                <div class="bx-im-fullscreen-popup-back"><a href="/"
                                                            onclick="bxFullscreenClose(); return false;"
                                                            class="bx-im-fullscreen-popup-back-link"><?= GetMessage('IM_FULLSCREEN_BACK') ?></a>
                </div>
            </td>
        </tr>
        <tr>
            <td class="bx-im-fullscreen-popup-td bx-im-fullscreen-popup-td2">
                <div class="bx-desktop-placeholder"
                     id="im-workarea-content"></div>
            </td>
        </tr>
        <tr>
            <td class="bx-im-fullscreen-popup-td bx-im-fullscreen-popup-td3">
				<span class="bx-im-fullscreen-apps">
					...
					<span class="bx-im-fullscreen-apps-buttons"
                          id="im-workarea-apps">
						<span class="bx-im-fullscreen-apps-buttons-group">
							<a href="http://dl.bitrix24.com/b24/bitrix24_desktop.exe"
                               class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-windows"
                               target="_blank"></a>
							<span class="bx-im-fullscreen-apps-buttons-delimiter"></span>
							<a href="http://dl.bitrix24.com/b24/bitrix24_desktop.dmg"
                               class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-osx"
                               target="_blank"></a>
							<span class="bx-im-fullscreen-apps-buttons-delimiter"></span>
							<a href="https://github.com/buglloc/brick/"
                               class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-linux"
                               target="_blank"></a>
						</span>
						<span class="bx-im-fullscreen-apps-buttons-group">
							<a href="https://play.google.com/store/apps/details?id=com.bitrix24.android"
                               class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-googleplay"
                               target="_blank"></a>
							<span class="bx-im-fullscreen-apps-buttons-delimiter"></span>
							<a href="<?= GetMessage('IM_FULLSCREEN_DOWN_ITS'); ?>"
                               class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-appstore"
                               target="_blank"></a>
						</span>
					</span>
				</span>
                <span class="bx-im-fullscreen-bg">
					...
					<span class="bx-im-fulsscrenn-bg-wrap">
						<span id="im-workarea-backgound-selector-title"
                              class="bx-im-fulsscrenn-bg-wrap-title">--------</span>
						<select id="im-workarea-backgound-selector"
                                class="bx-im-fullscreen-bg-selector">
...
?>
<div class="bx-im-bar <?= ($arResult['OL_OPERATOR'] ? "bx-im-bar-with-ol"
    : "") ?>" id="bx-im-bar">
    ...
    ?>
    <div id="bx-im-bar-notify"
         class="bx-im-informer <?= ($arResult['OL_OPERATOR'] ? ""
             : "bx-im-border-b") ?>">
        <div class="bx-im-informer-icon"
             title="<?= GetMessage('IM_MESSENGER_OPEN_NOTIFY'); ?>"></div>
        <div class="bx-im-informer-num"></div>
    </div>
    <? if ($arResult['OL_OPERATOR']): ?>
        <div id="bx-im-bar-ol"
             class="bx-im-informer bx-im-informer-ol bx-im-border-b">
            <div class="bx-im-informer-ol-icon"
                 title="<?= GetMessage('IM_MESSENGER_OPEN_OL'); ?>"></div>
            <div class="bx-im-informer-num"></div>
        </div>
    <? endif; ?>
    <div id="bx-im-bar-search" class="bx-im-search bx-im-border-b"
         title="<?= GetMessage('IM_MESSENGER_OPEN_SEARCH'); ?>">
        <div class="bx-im-informer-num"></div>
    </div>
    ...
    <div class="bx-im-bottom-block" id="bx-im-bottom-block">
        <div id="bx-im-bar-mobile" class="bx-im-bar-mobile"
             onclick="BX.UI.InfoHelper.show('mobile_app');">
            <div class="bx-im-mobile-icon"
                 title="<?= GetMessage('IM_MESSENGER_OPEN_MOBILE'); ?>"></div>
        </div>
        <? if ($arResult['PHONE_ENABLED']): ?>
            <div id="bx-im-btn-call" class="bx-im-btn-wrap bx-im-btn-call"
                 title="<?= GetMessage('IM_MESSENGER_OPEN_CALL2'); ?>">
    ...
    <svg width="0" height="0" style="display: block">
        <defs>
            <clipPath id="clip-avatar">
                <path d="M31.342 20.557a7.5 7.5 0 0 0-9.524 10.352A15.96 15.96 0 0 1 16 32C7.163 32 0 24.837 0 16S7.163 0 16 0s16 7.163 16 16c0 1.583-.23 3.113-.658 4.557z"
...
try {
    ...
    $tutorialDataJson = Json::encode([
        'tutorialData'  => Json::decode($externalData['tutorials']),
        'eventService'  => Json::decode($externalData['eventService']),
...
if (Loader::includeModule("ui")) {
    $helpdeskUrl = Util::getHelpdeskUrl(true);
}
?>
<script>
  BX.ready(function() {
