...
$arTemplateParameters = array(
    "USE_VIEW_SELECTOR" => array(
        "NAME"     => GetMessage('ISL_PARAM_DEFAULT_VIEW_SELECTOR'),
        "TYPE"     => "CHECKBOX",
        "MULTIPLE" => "N",
        "DEFAULT"  => 'Y',
    ),
    ...
    "TABLE_VIEW" => array(
        "NAME"     => GetMessage('ISL_PARAM_TABLE_VIEW'),
        "TYPE"     => "LIST",
        "VALUES"   => array(
            '.default'    => GetMessage('ISL_PARAM_LIST_VIEW_VALUE_list'),
            'group_table' => GetMessage('ISL_PARAM_LIST_VIEW_VALUE_group'),
        ),
        "MULTIPLE" => "N",
        "DEFAULT"  => 'group',
        'REFRESH'  => 'Y',
...
if ($arCurrentValues['LIST_VIEW'] == 'list') {
    ...
    if (CModule::IncludeModule('extranet')) {
        ...
        $arExtranetType = array(
            ""          => GetMessage("ISL_PARAM_EXTRANET_TYPE_CONTACTS"),
            "employees" => GetMessage("ISL_PARAM_EXTRANET_TYPE_EMPLOYEES"),
        );

        $arTemplateParameters['EXTRANET_TYPE'] = array(
            "NAME"     => GetMessage('ISL_PARAM_EXTRANET_TYPE'),
            "TYPE"     => "LIST",
            "VALUES"   => $arExtranetType,
            "MULTIPLE" => "N",
            "DEFAULT"  => "",
        );
    }
