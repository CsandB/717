        ...
        <div class="socialnetwork-group-sidebar-block-inner">
            <? if ($arResult["CanView"]["content_search"]): ?>
                <div class="socialnetwork-group-search">
                    <div class="socialnetwork-group-search-item">
                        <form class="socialnetwork-group-search-form"
                              action="<?= $arResult["Urls"]["content_search"] ?>">
                            <input
                                    class="socialnetwork-group-search-field"
                                    type="text"
                                    name="q"
                                    placeholder="<?= GetMessage($arResult['Group']['PROJECT']
                                    == 'Y'
                                        ? "SONET_UM_SEARCH_BUTTON_TITLE_PROJECT"
                                        : "SONET_UM_SEARCH_BUTTON_TITLE") ?>"
                            >
            ...
            <? if ($arResult["Owner"]):
                ...
                <div class="socialnetwork-group-users">
                    <div class="socialnetwork-group-users-inner socialnetwork-group-owner">
                        <div class="socialnetwork-group-title"><?= GetMessage($arResult['Group']['PROJECT']
                            == 'Y' ? "SONET_C6_OWNERN_PROJECT"
                                : "SONET_C6_OWNERN") ?></div>
                        <div class="socialnetwork-group-users-list">
                            <div class="socialnetwork-group-user socialnetwork-group-owner-user">
                                <a class="ui-icon ui-icon-common-user socialnetwork-group-user-avatar user-default-avatar"
								...
								<?= ($arResult["Owner"]["USER_IS_EXTRANET"]
                                    == "Y" ?
                                    ...
                                    <div class="socialnetwork-group-user-position"><?
                                        if (IsModuleInstalled("intranet")
                                            ...
                                            ?><?= $arResult["Owner"]["USER_WORK_POSITION"] ?><?
                                        elseif ($arResult["Owner"]["USER_IS_EXTRANET"]
                                            == "Y"
                                        ):
            ...
            <table cellspacing="0" class="socialnetwork-group-layout">
                <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column"><?= GetMessage("SONET_C6_CREATED") ?>
                        :
                    </td>
                ...
                <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column"><?= GetMessage("SONET_C6_NMEM") ?>
                        :
                    </td>
                    <td class="socialnetwork-group-layout-right-column"><?= $arResult["Group"]["NUMBER_OF_MEMBERS"] ?></td>
                </tr>
                <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column"><?= Loc::getMessage($arResult['Group']['PROJECT']
                        == 'Y' ? "SONET_C6_TYPE_PROJECT" : "SONET_C6_TYPE") ?>:
                    </td>
                ...
                if ($arResult['Group']['PROJECT'] == 'Y') {
                    if ( ! empty($arResult['Group']['PROJECT_DATE_START'])) {
                        ?>
                        <tr class="socialnetwork-group-layout-row">
                        <td class="socialnetwork-group-layout-left-column"><?= Loc::getMessage("SONET_C6_PROJECT_DATE_START") ?>
                            :
                        </td>
                        <td class="socialnetwork-group-layout-right-column"><?= FormatDateFromDB($arResult["Group"]["PROJECT_DATE_START"],
                                $arParams["DATE_FORMAT"], true) ?></td>
                        </tr><?
                    }
                    if ( ! empty($arResult['Group']['PROJECT_DATE_FINISH'])) {
                        ?>
                        <tr class="socialnetwork-group-layout-row">
                        <td class="socialnetwork-group-layout-left-column"><?= Loc::getMessage("SONET_C6_PROJECT_DATE_FINISH") ?>
                            :
                        </td>
                        <td class="socialnetwork-group-layout-right-column"><?= FormatDateFromDB($arResult["Group"]["PROJECT_DATE_FINISH"],
                                $arParams["DATE_FORMAT"], true) ?></td>
                        </tr><?
                    }
                }
                ...
                if ( ! empty($arResult["GroupDepartments"])) {
                    ?>
                    <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column"><?= GetMessage("SONET_C6_DEPARTMENTS") ?>
                        :
                    </td>
                    <td class="socialnetwork-group-layout-right-column"><?
                        ...
                        {
                            $arDepartmentFormatted[] = '<a href="'
                                .$arDepartment["URL"].'">'
                                .htmlspecialcharsEx($arDepartment["NAME"])
                                .'</a>';
                        }
                ...
                if ($arResult["GroupProperties"]["SHOW"] === "Y") {
                    foreach (
                        $arResult["GroupProperties"]["DATA"] as $fieldName =>
                        $arUserField
                    ) {
                        if (
                            ...
                            ?>
                            <tr class="socialnetwork-group-layout-row">
                            <td class="socialnetwork-group-layout-left-column"><?= $arUserField["EDIT_FORM_LABEL"] ?>
                                :
                            </td>
                            <td class="socialnetwork-group-layout-right-column"><?
                ...
                if (
                    ...
                    ?>
                    <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column"><?= Loc::getMessage("SONET_C6_TAGS") ?>
                        :
                    </td>
                    <td class="socialnetwork-group-layout-right-column">
                        <div class="socialnetwork-group-sidebar-tag-box"><?
                            foreach (
                                $arResult["Group"]["KEYWORDS_LIST"] as $keyword
                            ) {
                                ?><a bx-tag-value="<?= $keyword ?>"
                                     href="<?= CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_GROUP_TAG"],
                                         array('tag' => $keyword)); ?>"
                                     class="socialnetwork-group-sidebar-tag"><?= $keyword ?></a><?
                            }
                            ?></div>
                    </td>
                    </tr><?
                ...
                <div class="socialnetwork-group-desc-text"><?
                    ...
                    if ($descEnding <> ''):
                        ...
                        >
                            ...
                            class="socialnetwork-group-desc-full"><?= $descEnding ?></span>
                    <? endif ?>
                </div>
                </div><?
            }
            ...
            if ($arResult["Moderators"]["List"]):
                ...
                <div class="socialnetwork-group-users-inner">
                    <div class="socialnetwork-group-title"><?= GetMessage($arResult['Group']['PROJECT']
                        == 'Y' ? "SONET_C6_ACT_MODN_PROJECT"
                            : "SONET_C6_ACT_MODN") ?>
                        <? if (count($arResult["Moderators"]["List"])
                            > $itemsLimit
                        ): ?>
                            (<a
                    ...
                    <div class="socialnetwork-group-users-list">
                        <? foreach ($arResult["Moderators"]["List"] as $friend):
                            ...
                            $avatar
                                = $friend["USER_PERSONAL_PHOTO_FILE"]["SRC"];
                            ?>
								...
								">
                                    ...
                                    <div class="socialnetwork-group-user-position"><?
                                        if (IsModuleInstalled("intranet")
                                            ...
                                            ?><?= $friend["USER_WORK_POSITION"] ?><?
                                        elseif ($friend["USER_IS_EXTRANET"]
                                            == "Y"
                                        ):
                                            ?><?= GetMessage("SONET_C6_USER_IS_EXTRANET") ?><?
                                        else:
                ...
                <div class="socialnetwork-group-users-inner">
                    <div class="socialnetwork-group-title">
                        ...
                        if (
                            ...
                            ><?= Loc::getMessage($arResult['Group']['PROJECT']
                        == 'Y' ? "SONET_C6_ACT_REQU_PROJECT"
                            : "SONET_C6_ACT_REQU") ?></a><?
                        }
                        ?></div>
                    <div class="socialnetwork-group-users-list"><?
						...
						<?= ($friend["USER_IS_EXTRANET"] === "Y"
                                    ? "socialnetwork-group-extranet-user"
                                    : "") ?>">
                            <a href="<?= htmlspecialcharsback($friend["USER_PROFILE_URL"]) ?>"
                               class="ui-icon ui-icon-common-user socialnetwork-group-member-avatar"
                               title="<?= $userName ?>">
                                <i <? if ($avatar): ?>
                                    style="background: url('<?= $avatar ?>'); background-size: cover"
                                <? endif ?>></i>
