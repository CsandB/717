    ...
    if ($arResult["bDescPageNumbering"] === true) {
        ...
        if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) {
            ...
            if ($arResult["bSavePage"]) {
                $sPrevHref = $arResult["sUrlPath"].'?'.$strNavQueryString
                    .'PAGEN_'.$arResult["NavNum"].'='.($arResult["NavPageNomer"]
                        + 1);
            } else {
        ...
        if ($arResult["NavPageNomer"] > 1) {
            $bNextDisabled = false;
            $sNextHref = $arResult["sUrlPath"].'?'.$strNavQueryString.'PAGEN_'
        ...
        <div class="navigation-pages">
            ...
            do {
                ...
                if ($arResult["nStartPage"] <= 2
                    ...
                    || abs($arResult['nStartPage'] - $arResult["NavPageNomer"])
                    <= 2
                ) {
        ...
        <div class="navigation-pages">
            ...
            do {
                if ($arResult["nStartPage"] <= 2
                    ...
                    if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):
                        ?><span
                            class="navigation-current-page"><?= $arResult["nStartPage"] ?></span><?
