...
<div class="department-profile"><?
    ...
    $arFilterValues
        ...
        "sections", $arSelectorParams, $component);
    $current_section = intval($arFilterValues[$arParams['FILTER_NAME']
    .'_UF_DEPARTMENT']);
    ...
    <div class="department-profile-events">
        ...
        <div class="department-profile-events-cont">
            <? if (CModule::IncludeModule('bitrix24')
                ...
                <a class="department-profile-events-item department-profile-add-sub"
                   href="javascript:void(0)"
                   onclick="<?= CIntranetInviteDialog::ShowInviteDialogLink($arInviteParams) ?>"><i></i><?= GetMessage("INTR_IS_TPL_ACTION_INVITE") ?>
                </a>
            <?endif;
            ...
            ?>
            <a class="department-profile-events-item department-profile-subsection"
               href=""
               onclick="BX.IntranetStructure.ShowForm(<?= CUtil::PhpToJSObject($arStructureParams) ?>); return false;"><i></i><?= GetMessage("INTR_IS_TPL_ACTION_ADD_DEP") ?>
            </a>
            <?
            if (intval($current_section) > 0):
                ...
                ?>
                <a class="department-profile-events-item department-profile-edit"
                   href=""
                   onclick="BX.IntranetStructure.ShowForm(<?= CUtil::PhpToJSObject($arStructureParams) ?>); return false;"><i></i><?= GetMessage("INTR_IS_TPL_ACTION_EDIT_DEP") ?>
                </a>
                <? if ($arParams["TOP_DEPARTMENT"] != $current_section):?>
                <a class="department-profile-events-item department-profile-remove"
                   onclick="
                           ...
                           return false;"
                   href="javascript:void(0)"><i></i><?= GetMessage("INTR_IS_TPL_ACTION_DELETE_DEP") ?>
                </a>
            <?endif ?>
            <?endif ?>
        </div>
